...
(function() {
  ...
  Network = function() {
    ...
    network.setGrouping = function(newGrouping) {
    ...
    setupData = function(data) {
      ...
      data.nodes.forEach(function(n) {
        ...
        return n.radius = circleRadius(n.length);
      });
    ...
    sortedcolors = function(nodes, links) {
      var colors, counts;
      colors = [];
      if (sort === "links") {
        counts = {};
        links.forEach(function(l) {
          ...
          if ((_ref1 = counts[_name1 = groupBy(l.source)]) == null) {
            counts[_name1] = 0;
          }
          return counts[groupBy(l.source)] += 1;
        });
        nodes.forEach(function(n) {
          var _name, _ref;
          return (_ref = counts[_name = groupBy(n)]) != null ? _ref : counts[_name] = 0;
        });
        colors = d3.entries(counts).sort(function(a, b) {
    ...
    updateNodes = function() {
      ...
      node.enter().append("circle").attr("class", "node").attr("cx", function(d) {
        ...
        return d.y;
      }).attr("width", "16px").attr("height", "16px").attr("r", function(d) {
        return d.radius;
    ...
    setLayout = function(newLayout) {
      layout = newLayout;
      if (layout === "force") {
        return force.on("tick", forceTick).charge(-500).linkDistance(200);
  ...
  $(function() {
    ...
    d3.selectAll("#groupings a").on("click", function(d) {
      var newGrouping;
      newGrouping = d3.select(this).attr("id");
      activate("groupings", newGrouping);
      return myNetwork.setGrouping(newGrouping);
    });
    ...
    return d3.json("data/skirts.json", function(json) {
